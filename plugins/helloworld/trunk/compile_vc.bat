...
cl /Zp2 /O1igy /GF /Gr /GR- /GX- /LD /Gs10000 HelloWorld.c /link /subsystem:console /machine:I386 /opt:nowin98 /noentry /nodefaultlib /def:HelloWorld.vc.def kernel32.lib advapi32.lib user32.lib /map:HelloWorld.map /merge:.rdata=.text
