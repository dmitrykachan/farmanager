...
/*******************************************************************
   INTERFACE
 *******************************************************************/
// FAR_EXTERN FTPPluginInterface* FAR_DECLSPEC FTPQueryInterface( FTPInterface* Info )
//   {
 ...
 *******************************************************************/
#if defined( __FP_INFO_FUNCTIONS__ )
//  size_t DECLSPEC    VSNprintf( char *Buff,size_t cn,CONSTSTR Fmt,va_list arglist )  { RTLCheck("VSNprintf") return FTP_Info->VSNprintf( Buff,cn,Fmt,arglist ); }
