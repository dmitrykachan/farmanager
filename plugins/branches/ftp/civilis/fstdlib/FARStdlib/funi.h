...
extern int DECLSPEC FP_Color(INT_PTR far_color_num );
...
// --------------------------------------------------------------
  ...
  extern std::wstring				g_pluginStartPath;
  extern std::wstring				g_PluginRootKey;
...
*/
#if !defined(__FP_NOT_FUNCTIONS__)
  extern const char* DECLSPEC FP_GetPluginName();
  extern const wchar_t* DECLSPEC FP_GetPluginNameW();
#endif
...
inline bool FISMSG(const char* v)
{
	return (v != 0) && (reinterpret_cast<INT_PTR>(v) > FAR_MAX_LANGID);
}
...
#if !defined(__FP_NOT_FUNCTIONS__)
/*
  extern int   DECLSPEC FP_GetRegKey(const wchar_t* Key,CONSTSTR ValueName,DWORD Default);
  extern int   DECLSPEC FP_GetRegKey(const wchar_t* Key, const wchar_t* valueName, DWORD Default);
  extern BYTE *DECLSPEC FP_GetRegKey(const wchar_t* Key,CONSTSTR ValueName,BYTE *ValueData,LPCBYTE Default,DWORD DataMaxSize);
  extern char *DECLSPEC FP_GetRegKey(const wchar_t* Key,CONSTSTR ValueName,char *ValueData,CONSTSTR Default,DWORD DataMaxSize);
  ...
  inline BYTE *DECLSPEC FP_GetRegKey(CONSTSTR ValueName,BYTE *ValueData,LPCBYTE Default,DWORD DataSize)               { return FP_GetRegKey(NULL,ValueName,ValueData,Default,DataSize); }
	std::wstring DECLSPEC FP_GetRegKey(const wchar_t* Key, const wchar_t* valueName, const std::wstring &defaultValue);
  inline std::wstring DECLSPEC FP_GetRegKey(const wchar_t* valueName, const std::wstring &defaultValue) {return FP_GetRegKey(NULL, valueName, defaultValue); }
	inline int   DECLSPEC FP_GetRegKey(const wchar_t* valueName, DWORD Default) { return FP_GetRegKey(NULL, valueName, Default); }

  extern BOOL  DECLSPEC FP_SetRegKey(const wchar_t* Key,CONSTSTR ValueName,DWORD ValueData);
  extern BOOL  DECLSPEC FP_SetRegKey(const wchar_t* Key,CONSTSTR ValueName,LPCBYTE ValueData,DWORD ValueSize);
  extern BOOL  DECLSPEC FP_SetRegKey(const wchar_t* Key,CONSTSTR ValueName,CONSTSTR ValueData);
  ...
  bool  DECLSPEC FP_SetRegKey(const wchar_t* Key, const wchar_t* ValueName, const std::wstring &value);
  bool  DECLSPEC FP_SetRegKey(const wchar_t* Key, const wchar_t* ValueName, const std::string &value);
  extern bool  DECLSPEC FP_SetRegKey(const wchar_t* Key, const wchar_t* ValueName, const std::wstring &value);
  inline BOOL  DECLSPEC FP_SetRegKey(const wchar_t* ValueName, const std::wstring &value)             { return FP_SetRegKey(NULL, ValueName, value); }

  inline bool  DECLSPEC FP_SetRegKey(const wchar_t* ValueName, const std::string &value)			{ return FP_SetRegKey(NULL, ValueName, value); }

  extern HKEY  DECLSPEC FP_CreateRegKey(const wchar_t* Key );
  extern HKEY  DECLSPEC FP_OpenRegKey(const wchar_t* Key);
  extern bool  DECLSPEC FP_CheckRegKey(const std::wstring &Key);
...
*/
#if !defined(__FP_NOT_FUNCTIONS__)
  extern size_t DECLSPEC FP_ConWidth( void );
...
*/
#if !defined(__FP_NOT_FUNCTIONS__)
  extern void     DECLSPEC FP_SetStartupInfo( const PluginStartupInfo *Info, const std::wstring &plugginName);
