...
inline void          GET_TIME( TIME_TYPE& var )                 { /*TODO var = timeGetTime();*/ }
...
*/
  ...
  extern size_t  DECLSPEC_PT SNprintf( char *Buff,size_t cn,CONSTSTR Fmt,... );
  extern size_t  DECLSPEC    VSNprintf( char *Buff,size_t cn,CONSTSTR Fmt,va_list arglist );
  ...
  extern char   *DECLSPEC StrCpy( char *dest,CONSTSTR src,size_t dest_sz = -1 );
